...
```toml
[dependencies]
terrace-config = { git = "https://github.com/TimSchoenle/terrace-config", tag = "v0.8.0" }
```
...
```toml
[dev-dependencies]
terrace-config = { git = "…", tag = "v0.8.0", features = ["testing"] }
```
...
```toml
terrace-config = { git = "…", tag = "v0.8.0", default-features = false, features = ["loader"] }
```
...
```toml
terrace-config = { git = "…", tag = "v0.8.0", features = ["explain"] }
```
...
```toml
terrace-config = { git = "…", tag = "v0.8.0", features = ["schema"] }
```
...
```toml
[dependencies]
terrace-config = { git = "…", tag = "v0.8.0", features = ["schema-cli"] }
...
[dependencies]
terrace-config = { git = "…", tag = "v0.8.0" }   # no `schema` here
