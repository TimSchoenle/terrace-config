...
```toml
[dependencies]
terrace-config = { git = "https://github.com/TimSchoenle/terrace-config", tag = "v0.9.1" }
```
...
```toml
[dev-dependencies]
terrace-config = { git = "…", tag = "v0.9.1", features = ["testing"] }
```
...
```toml
terrace-config = { git = "…", tag = "v0.9.1", default-features = false, features = ["loader"] }
```
...
```toml
terrace-config = { git = "…", tag = "v0.9.1", features = ["explain"] }
```
...
```toml
terrace-config = { git = "…", tag = "v0.9.1", features = ["schema"] }
```
...
```toml
[dependencies]
terrace-config = { git = "…", tag = "v0.9.1", features = ["schema-cli"] }
...
[dependencies]
terrace-config = { git = "…", tag = "v0.9.1" }   # no `schema` here
